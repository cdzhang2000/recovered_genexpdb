...
sub info {
	print
	  ...
	  #czhang July 12, 2013
	  qq{<tr>\n}, 
	  qq{<td class="tdl"><a class="mnl" onclick="gm('downloadExpMetaData');">Download Exp MetaData</a></td>\n}, 
	  qq{<td class="tdl">Select Accessions/Experiments for download</td>\n}, 
	  qq{</tr>\n},
...
#--------------------------------------------------------------------
# select accessions/experiments to download metadata
# input: none
# return: none
#----------------------------------------------------------------------
sub downloadExpMetaData {
	...
	print
	  ...
	  qq{<h3>GenExpDB Download Data</h3>\n},
	   ...
	   #czhang July 11, 2013	 	  
	   qq{<input class="ebtn" type="button" name="downloadExpMetaData" value="downloadExpMetaData" onclick="downloadMetadata();"> &nbsp;&nbsp;<span class="small">Select Accessions then click "download" to download Exp metadata</span>\n},
