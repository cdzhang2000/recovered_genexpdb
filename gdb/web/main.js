...
function downloadMetadata() {
	...
	window.open('/modperl/gdb/download.pl?type=metadata&ckdlaccn='+ckdlaccn+'&ckdlexpm='+ckdlexpm);
}
...
//	if (cntlgenome.length <1) {alert('Control Genome must be selected!');return false;}
	...
	rec.innerHTML = '<div align="center"><img src="/modperl/gdb/web/running.gif" alt=""></div>';
	sendRequest('/gdb/', 'ajax=accinfo&accinfo=sel1Plot&id='+id+'&log='+log+'&normalize='+normalize+'&antilog='+antilog+'&antilog2='+antilog2+'&userma='+userma+'&plottype='+plottype+'&testname='+testnameArr+'&testgenome='+testgenome+'&cntlname='+cntlnameArr+'&cntlgenome='+cntlgenome+'&datacol='+datacol);
	rec.className = 'showrec';
}
...
//	if (cntlgenome.length <1) {alert('Genome must be selected!');return false;}
	...
	rec = document.getElementById('selPlot'+id);
	rec.innerHTML = '<div align="center"><img src="/modperl/gdb/web/running.gif" alt=""></div>';
	sendRequest('/gdb/', 'ajax=accinfo&accinfo=sel2Plot&id='+id+'&log='+log+'&normalize='+normalize+'&antilog='+antilog+'&antilog2='+antilog2+'&plottype='+plottype+'&sampname='+sampnameArr+'&cntlgenome='+cntlgenome+'&testcol='+testcol+'&testbkgd='+testbkgd+'&cntlcol='+cntlcol+'&cntlbkgd='+cntlbkgd);
	rec.className = 'showrec';
}
...
function savExptoDB_2(event,selid,inputid){
	...
	sendRequest('/gdb/', 'ajax=accinfo&accinfo=savExptoDB&expname='+expname+'&info='+info+'&vbi_organism='+vbi_organism+'&vbi_strain='+vbi_strain+'&vbi_mutant='+vbi_mutant+'&vbi_cond='+vbi_cond+'&vbi_timepoint='+vbi_timepoint);
