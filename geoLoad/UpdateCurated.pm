...
sub loadGSEs
{
	...
	my $sql ="INSERT INTO CURATED (ACCESSION, TITLE, STRAIN, SUBSTRAIN, GEOMATCH, PMID, RELEASE_DATE, status, Institution, ADDUSER, ADDDATE ) VALUES(?, ?, ?, ?, ?, ?, TO_DATE(?, 'MM/DD/YYYY'), ?, ?, 'czhang', sysdate)";
